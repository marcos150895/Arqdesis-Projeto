...
/**
 * Servlet implementation class ExcluirBuscarCarro
 */
@WebServlet("/ExcluirBuscarCarro")
public class ExcluirBuscarCarro extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ExcluirBuscarCarro() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("listaVeiculos", to);
		RequestDispatcher view = request
				.getRequestDispatcher("ExcluirCarroPronto.jsp");
