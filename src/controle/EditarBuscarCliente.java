...
/**
 * Servlet implementation class EditarBuscarCliente
 */
@WebServlet("/EditarBuscarCliente")
public class EditarBuscarCliente extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditarBuscarCliente() {
        super();
	...
	protected void doPost(HttpServletRequest request,
		...
		RequestDispatcher view = request
				.getRequestDispatcher("EditarClientePronto.jsp");
