...
public class AlterarCliente extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		String validade_cnh = request.getParameter("mes_validade_cnh") + "/"
				+ request.getParameter("ano_validade_cnh");
		String data_nasc = request.getParameter("nascimento");
		String genero = request.getParameter("genero");
		String ee = request.getParameter("ee");
		String telefone = request.getParameter("telRes");
		String comercial = request.getParameter("telCom");
		String celular = request.getParameter("telCel");
