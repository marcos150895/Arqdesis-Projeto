							...
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate
										...
										action="ExcluirBuscarCarro" method="post">

										<div class="form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12">Parametro<span class="required">*</span>
												</label>
														...
														<tbody>
															<%
																...
																for (Veiculo veiculo : listaVeiculos) {
																	...
																	out.println("<td><a href=ExcluirCarro?id="
																			+ veiculo.getCodigo() + ">"
