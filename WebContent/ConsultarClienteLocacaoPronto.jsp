				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="x_panel">
								<b>
									<h1>Consulta de Cliente Locação</h1>
								</b>
							</div>
							<div class="x_panel">
								<!--conteudo---------------------------->
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate action ="BuscarClienteLocacao?&idcarro=<%=request.getParameter("idcarro")%>" method = "post"
													...
													<table class="table table-hover">
														...
														ArrayList<Cliente> lista = to.getLista(); 
														 for (Cliente cliente : lista) {
															...
															out.println("<th>"  + cliente.getCodigoCliente()
																		+ "</th>");
															out.println("<td>" + cliente.getNome()
																		+ "</td>");
															out.println("<td>" + cliente.getCpf()
																		+ "</td>");
															out.println("<td>" + cliente.getRg()
																	+ "</td>");
															out.println("<td>" + cliente.getValidade_cnh()
																		+ "</td>");	
															out.println("<td>" + cliente.getData_nasc()
																	+ "</td>");
															out.println("<td>" + cliente.getGenero()
																	+ "</td>");	
															out.println("<td>" + cliente.getEe()
																+ "</td>");
															out.println("<td>" + cliente.getTelefone()
																+ "</td>");	
															out.println("<td>" + cliente.getCelular()
																	+ "</td>");	
															out.println("<td>" + cliente.getComercial()
																	+ "</td>");	
																
															out.println("<td>" + cliente.getEmail()
																	+ "</td>");	
															out.println("<td><a href=Locacao.jsp?idcliente="+cliente.getCodigoCliente() +
																	"&idcarro="+ request.getParameter("idcarro")+">"
