							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-table"></i> Relatórios <span
									...
									<ul class="nav child_menu" style="display: none">
										...
										<li><a href="RelatorioMes.html">Relatório do Mês</a></li>
									</ul></li>
							...
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate
										class="form-horizontal form-label-left" action="BuscarLocacao"
										method="post">
													...
													<table class="table table-hover">
														<thead>
															<tr>
																...
																<th>Id cliente</th>
																<th>Id veiculo</th>
																<th>Estado locacao</th>
																<th>Cidade locacao</th>
																<th>Estado devolucao</th>
																<th>Cidade devolucao</th>
																<th>Tarifa</th>
																<th>Data locacao</th>
															...
															<%
																LocacaoTO to = (LocacaoTO) request.getAttribute("listaLoc");
																ArrayList<Locacao> lista = to.getlistaLocacao();
																for (Locacao loc : lista) {

																	out.println("<tr name = " + loc.getId_locacao() + ">");
																	out.println("<th>" + loc.getId_locacao() + "</th>");
																	out.println("<th>" + loc.getId_cliente() + "</th>");
																	out.println("<td>" + loc.getId_veiculo() + "</td>");
																	out.println("<td>" + loc.getEstado_locacao() + "</td>");
																	out.println("<td>" + loc.getCidade_locacao() + "</td>");
																	out.println("<td>" + loc.getEstado_devolucao() + "</td>");
																	out.println("<td>" + loc.getCidade_devolucao() + "</td>");
																	out.println("<th>" + loc.getTarifa_locacao() + "</th>");
																	out.println("<td>" + loc.getData_horalocacao() + "</td>");
																	out.println("<td>" + loc.getData_devo() + "</td>");

																	out.println("<td><a href=Devolucao.jsp?idLocacao="
																			+ loc.getId_locacao() + ">"
