							...
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate
										action="EditarBuscarCliente" method="post"
														...
														<tbody>
															<%
																...
																for (Cliente cliente : lista) {
																	...
																	out.println("<tr id = " + cliente.getCodigoCliente() + ">");
																	...
																	out.println("<td><a href=EditarRetonarCliente?id="+cliente.getCodigoCliente() + ">"
