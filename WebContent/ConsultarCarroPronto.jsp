							...
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate
										class="form-horizontal form-label-left" action="BuscarVeiculo"
										method="post">
										...
										<div class="form-group">
											...
											<div class="col-md-3 col-sm-3 col-xs-12">
												<select required="required" name="parametro" class="form-control">
													<option></option>
													<option>Placa</option>
										...
										<div class="form-group">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
												<input type="text" name="pesquise" id="pesquise" required="required"
