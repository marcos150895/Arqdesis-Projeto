							...
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate
										class="form-horizontal form-label-left" action="DevolucaoPronta" method="post">

										<div class="form-group">
											<label class="col-sm-3 control-label">Numero locacao</label>
											<%
												String num = request.getParameter("idLocacao");
												if (num == null) {
													num = " ";
												}
											...
											<div class="col-sm-3">
												<div class="input-group">
													<input type="text" class="form-control" value="<%=num%>"
														readonly="readonly" name="locacao"> <span
														class="input-group-btn"><a
														href="BuscarLocacao.html">
										...
										<div class="form-group">
											...
											<div class="col-md-3 col-sm-3 col-xs-12">
												<input type="search" id="km"
													class="form-control col-md-7 col-xs-12" name = "km">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12"
											...
											<div class="col-md-3 col-sm-3 col-xs-12">
												<input type="text" id="pesquise" readonly="readonly" name ="total"
