				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="x_panel">
								<b>
									<h1>Consulta de Carro locação</h1>
								</b>
							</div>
							<div class="x_panel">
								<!--conteudo---------------------------->
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate
										class="form-horizontal form-label-left" action="BuscarVeiculoLocacao?&idcliente=<%=request.getParameter("idcliente")%>"
										method="post">
										...
										<div class="form-group">
											...
											<div class="col-md-3 col-sm-3 col-xs-12">
												<select required="required" name="parametro"
													class="form-control">
													<option></option>
													<option>Placa</option>
											...
											<div class="x_panel">
												<div class="x_content">
													<table class="table table-hover">
														...
														<tbody>
															<%
																VeiculoTO to = (VeiculoTO) request.getAttribute("listaCarros");
																ArrayList<Veiculo> lista = to.getlistaVeiculos();
																for (Veiculo veiculo : lista) {

																	out.println("<tr name = " + veiculo.getCodigo() + ">");
																	...
																	out.println("<td><a href=Locacao.jsp?idcarro="
																			+ veiculo.getCodigo() +"&idcliente="+ 
